...
class GenerationMixin:
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        if "different_input_length" in model_kwargs:
            different_input_length = model_kwargs["different_input_length"]
            model_kwargs["different_input_length"] = different_input_length.index_select(0, expanded_return_idx)
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if 'different_input_length' in model_kwargs:
                next_tokens_logits = outputs.logits[torch.arange(batch_size), different_input_length.squeeze(1), :]
            else:
